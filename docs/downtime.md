...
- Table text may end with one or more `[Money](100)`, `[Humanity](2d6)`, `[Hitpoints](-2d5)`, or `[Reputation](-1)` tags. All types accept signed whole amounts. Humanity and Hitpoints also accept positive Xd6 and negative Xd6 or Xd5, as specified. Missing or malformed payout endings are ordinary result text and are silently ignored; no partial payout is applied for a malformed trailing block.
